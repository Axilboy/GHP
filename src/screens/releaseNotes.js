...
export const screenshotFolders = [
  {
    title: '17.08.2026 - релиз v0.6.0: новая «Правда или действие»',
    description: 'Игра переработана: игрок сам выбирает правду или действие и видит карточку только после выбора, а засчитывает её компания голосованием. Отказ теперь стоит одного из двух жетонов на игру. Карточек стало вдвое больше, они разделены по уровню смелости и обращаются к игрокам по именам. В «Шпионе» добавлена кнопка «ШПИОН» для досрочного голосования, секретная карточка переворачивается сколько угодно раз, а длинные названия локаций больше не вылезают за карту.',
    shots: [],
  },
  {
