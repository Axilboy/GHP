...
import { TruthDareGame } from '../games/truthdare/TruthDare';
...
export function Game({ room, me, isHost, card, revealRole, action, leave, navigate, catalog, now, error }) {
  ...
  if (room.gameId === 'truthdare') return <TruthDareGame room={room} me={me} action={action} leave={leave} navigate={navigate} error={error} />;
